...
const timelineItems = [
  {
    tag: "2026 - Present",
    title: "Actively Job Seeking",
    subtitle: "Open to Full-Time & Freelance",
    desc: "Looking for Full Stack Developer roles where I can build modern, scalable web products and grow with a strong team.",
    side: "right",
    isCurrent: true,
  },
  {
    ...
    desc: "Built official production websites for Tyrano Softwares and Tyrano.in. Worked with React, modern CSS, and responsive design.",
    side: "left",
  },
  {
    tag: "2023 - 2027",
    ...
    desc: "Currently pursuing B.Tech in CSE. Graduating 2027. Focused on DSA, Full Stack Development, and system design.",
    side: "right",
  },
  {
    tag: "2023",
